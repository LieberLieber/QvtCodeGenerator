...
namespace LL.MDE.Components.Qvt.Metamodel.QVTRelation
{
    ...
    public class RelationOperationalImplCollection : ObservableOppositeSet<IRelation, IRelationImplementation>
    {
        ...
        protected override void SetOpposite(IRelationImplementation item, IRelation parent)
        {
            if ((parent != null))
            {
