...
namespace LL.MDE.Components.Qvt.Metamodel.EssentialOCL
{
    ...
    /// <summary>
    /// The default implementation of the LiteralExp class
    /// </summary>
    [XmlNamespaceAttribute("http://www.omg.org/spec/QVT/20140401/EssentialOCL")]
    [XmlNamespacePrefixAttribute("essentialocl")]
    [DebuggerDisplayAttribute("LiteralExp {Name}")]
    public abstract class LiteralExp : OclExpression, ILiteralExp, IModelElement
    {
