...
namespace LL.MDE.Components.Qvt.Metamodel.EssentialOCL
{
    ...
    public class UnlimitedNaturalExp : NumericLiteralExp, IUnlimitedNaturalExp, IModelElement
    {
        ...
        public virtual Nullable<int> Symbol
        {
            get
            {
                return this._symbol;
            ...
            set
            {
                ...
                {
                    this.OnSymbolChanging(EventArgs.Empty);
        ...
        /// </summary>
        public event EventHandler SymbolChanging;
        
        /// <summary>
        /// Gets fired when the Symbol property changed its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> SymbolChanged;
        
        /// <summary>
        /// Raises the SymbolChanging event
        /// </summary>
        /// <param name="eventArgs">The event data</param>
        protected virtual void OnSymbolChanging(EventArgs eventArgs)
        {
            EventHandler handler = this.SymbolChanging;
            if ((handler != null))
            {
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.SymbolChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
