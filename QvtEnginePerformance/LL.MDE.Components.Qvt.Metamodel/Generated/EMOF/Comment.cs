...
namespace LL.MDE.Components.Qvt.Metamodel.EMOF
{
    ...
    public class Comment : Element, IComment, IModelElement
    {
        ...
        /// </summary>
        private ObservableAssociationSet<INamedElement> _annotatedElement;
        ...
        [XmlAttributeAttribute(true)]
        [ConstantAttribute()]
        public virtual ISetExpression<INamedElement> AnnotatedElement
        {
            get
            {
        ...
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void AnnotatedElementCollectionChanged(object sender, System.Collections.Specialized.NotifyCollectionChangedEventArgs e)
        {
            this.OnCollectionChanged("AnnotatedElement", e);
        }
        ...
        public class CommentReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            {
                INamedElement annotatedElementCasted = item.As<INamedElement>();
            ...
            public override bool Remove(IModelElement item)
            {
                ...
                if (((namedElementItem != null) 
                            && this._parent.AnnotatedElement.Remove(namedElementItem)))
                {
                    return true;
                }
                return false;
