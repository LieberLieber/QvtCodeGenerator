...
namespace LL.MDE.Components.Qvt.Metamodel.EMOF
{
    ...
    public class OperationOwnedParameterCollection : ObservableOppositeOrderedSet<IOperation, IParameter>
    {
        
        public OperationOwnedParameterCollection(IOperation parent) : 
                base(parent)
        {
        }
