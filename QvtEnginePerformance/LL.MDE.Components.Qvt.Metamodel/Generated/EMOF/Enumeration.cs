...
namespace LL.MDE.Components.Qvt.Metamodel.EMOF
{
    ...
    public class Enumeration : DataType, IEnumeration, IModelElement
    {
        ...
        [ConstantAttribute()]
        public virtual IOrderedSetExpression<IEnumerationLiteral> OwnedLiteral
        {
            get
            {
        ...
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void OwnedLiteralCollectionChanged(object sender, System.Collections.Specialized.NotifyCollectionChangedEventArgs e)
        {
            this.OnCollectionChanged("OwnedLiteral", e);
        }
