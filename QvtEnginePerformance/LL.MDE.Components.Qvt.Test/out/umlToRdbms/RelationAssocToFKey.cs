namespace LL.MDE.Components.Qvt.Transformation.umlToRdbms
{
	...
	public class RelationAssocToFKey
	{
		...
		{
			ISet<CheckResultAssocToFKey> result = new HashSet<CheckResultAssocToFKey>();ISet<MatchDomainA> matchDomainAs = CheckDomainA(a);
			...
			CheckResultAssocToFKey checkonlysMatch = new CheckResultAssocToFKey () {matchDomainA = matchDomainA,
			};
		...
		{
			MatchDomainFk match = new MatchDomainFk();LL.MDE.DataModels.SimpleUML.Association a = checkresult.matchDomainA.a;
			...
			LL.MDE.DataModels.SimpleUML.Class dc = checkresult.matchDomainA.dc;
					...
					//var RelationClassToTableResult =  transformation.RelationClassToTable.FindPreviousResult(sc) ;
					//var RelationClassToTableResult =  transformation.RelationClassToTable.FindPreviousResult(dc) ;
